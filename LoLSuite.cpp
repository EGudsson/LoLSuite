...
void manageTasks(const std::wstring& task) {
    if (task == L"cafe") {
        ...
        std::vector<std::wstring> apps = {
            ...
            L"9MZPRTH5C0TB", L"9MZ1SNWT0N5D", L"9P95ZZKTNRN4", L"9N0DX20HK701", L"9N8G5RFZ9XK3", L"9MVZQVXJBQ9V",
            L"9N4D0MSMP0PT", L"9N5TDP8VCMHS", L"9N95Q1ZZPMH4", L"9NCTDW2W1BH8", L"9NQPSL29BFFF", L"9PB0TRCNRHFX",
